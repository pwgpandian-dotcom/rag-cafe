...
export default async function HomePage() {
  ...
  if (presentKinds.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] gap-2 text-center px-8">
        ...
        <p className="font-semibold text-gray-700">No counters open right now</p>
        <p className="text-sm text-gray-400">Check back at breakfast or lunch.</p>
      </div>
    )
  }
